...
// Additional macros by Arne Bartels and Dai Griffiths (mainly Arne Bartels) 2003 - 2009
// Renamed to <fsver>gauges.h by Dai Griffiths to specify which version the corrections were made for.
// _sp2a suffix added to distinguish this version from the original fsx acceleration release.
...
#define KEY_ID_MIN                      0x00010000	//65536
...
#define KEY_TOGGLE_STROBE_LIGHTS        (KEY_ID_MIN + 24)
...
#define KEY_TOGGLE_LANDING_LIGHTS       (KEY_ID_MIN + 215)
...
// #define KEY_FREEZE_LATITUDE_LONGITUDE_TOGGLE    (KEY_ID_MIN + 1295)	// Sp.
// #define KEY_FREEZE_LATITUDE_LONGITUDE_SET       (KEY_ID_MIN + 1296)	// Sp.
...
typedef void VGAUGE_KEY_EVENT_HANDLER (ID32 event, UINT32 evdata, PVOID userdata);
...
#define IMAGE_ERASE_ALWAYS              BIT16		// Erase the entire image before redrawing. Use for HUDs etc. but will affect framerate
